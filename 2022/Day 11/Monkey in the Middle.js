...
while(currentRound <= numRounds)
{
    for(var i = 0; i < input.length; i++)
    {
        while(input[i][0].items.length)
        {
            ...
            //item's remainder after dividing the product of divisors will keep item's value under divisor's value while still being mathematically logical
            item = item % divisor;
...
inspectedItemsPerMonkey.sort((a,b) => b - a);
